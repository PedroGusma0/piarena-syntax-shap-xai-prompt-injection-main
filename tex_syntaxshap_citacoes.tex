% Requer no preâmbulo do documento-pai: \usepackage{float} (para o especificador [H] da figura),
% além de biblatex (\textcite/\parencite), booktabs e tabularx (já assumidos pelo arquivo de referência).
